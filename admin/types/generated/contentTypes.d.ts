...
export interface ApiCommentComment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    parent_id: Attribute.BigInteger;
...
export interface ApiCtaCta extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    component_name: Attribute.String & Attribute.Required & Attribute.Unique;
    image: Attribute.Media;
    posts: Attribute.Relation<'api::cta.cta', 'oneToMany', 'api::post.post'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    blog_content: Attribute.RichText & Attribute.Required & Attribute.Private;
    ...
    new_content: Attribute.Text;
    toc: Attribute.Text;
    new_toc: Attribute.Text;
    is_published: Attribute.Boolean & Attribute.DefaultTo<false>;
    cta: Attribute.Relation<'api::post.post', 'manyToOne', 'api::cta.cta'>;
    keywords: Attribute.String;
    new_blog_content: Attribute.JSON &
      Attribute.CustomField<'plugin::blog-editor.editor'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
